...
use myvm::binfmt::BinaryFile;
use myvm::{Addressable, LinearMemory, Machine, MemoryError, Register, VM};

struct IODevice;

impl Addressable for IODevice {
    fn read(&self, _addr: u32) -> Result<u8, MemoryError> {
        Ok(0)
    }
...
fn main() -> Result<(), String> {
    ...
    println!("program finished, system shutting down");
